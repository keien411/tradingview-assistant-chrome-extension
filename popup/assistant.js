...
function setClickEvents() {
  for(let elId of ['uploadSignals', 'testStrategy', 'deepTestStrategy', 'groupTestStrategy', 'previewStrategyTestResults', 'downloadStrategyTestResults', 'getStrategyTemplate', 'uploadStrategyTestParameters', 'clearAll', 'show3DChart']) {
